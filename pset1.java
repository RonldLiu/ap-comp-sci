...
public class pset1{
    static public void main(String[] args){      
        ...
        int q_a = 1, q_b = 5, q_c = 6; //variables
        ...
        int s_1x = 0, s_1y = 0, s_2x = 2, s_2y = 3; //variables
        ...
        int m_1x = 0, m_1y = 0, m_2x = 2, m_2y = 3; //variables
        double m_ansX = (double)(m_1x + m_2x) / 2;
        ...
        int a_num = 5; //variables
        double a_sta = 1.0, a_inc = 1.0; //variables
        ...
        int g_num = 3; //variables
        double g_sta = 3.0, g_rat = 2.0; //variables
